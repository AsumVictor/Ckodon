        ...
        >
          ...
          <p className="font-bold flex flex-row items-start mt-10">
            * NB: If you do not have a copy of your WASSCE results, type the
            subject and the grade obtained in each of them in the space provided
            below
          </p>
          <textarea
            name="wassce"
          ...
          <div className="essays mt-10">
            ...
            <p className="mt-5">
              <HiInformationCircle /> Write an essay of 300-400 words or more on
            ...
            <div className="prompt mt-4">
              <label htmlFor="question2" className="mt-5">
                ...
                <div className="checkbtn">
                  ...
                  prompted personal growth and a new knowledge of yourself or
                  others. <div className="box"></div>
                </div>
              </label>
            </div>
            <div className="prompt mt-4">
              <label htmlFor="question3" className="mt-5">
                ...
                />
                <div className="checkbtn">
                  3. The lessons we learn from our setbacks might be crucial to
                  our long-term success. Recount a period when you were
            ...
            <div className="prompt mt-4">
              <label htmlFor="question4" className="mt-5">
                ...
                />
                <div className="checkbtn">
                  4.Share an essay on any subject you want. It can be one that
                  you've already written, one that responds to a new scenario,
